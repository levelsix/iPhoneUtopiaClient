...
@private
  ...
  BOOL hasNumTimesToBuyStarterPack_:1;
  BOOL hasNumDaysToBuyStarterPack_:1;
...
@property (readonly) int32_t numTimesToBuyStarterPack;
@property (readonly) int32_t numDaysToBuyStarterPack;
