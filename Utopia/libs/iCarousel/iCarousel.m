...
- (CATransform3D)transformForItemView:(UIView *)view withOffset:(CGFloat)offset
{
  ...
  switch (_type)
  {
    ...
    case iCarouselTypeCoverFlow2:
    {
      ...
      CGFloat scale = (1.-ABS(clampedOffset))*0.08+0.92;
      ...
      else
      {
        ...
        return CATransform3DScale(CATransform3DRotate(transform, -clampedOffset * M_PI_2 * tilt, 0.0f, 1.0f, 0.0f), scale, scale, 1.);
      }
    }
    case iCarouselTypeTimeMachine:
    case iCarouselTypeInvertedTimeMachine:
