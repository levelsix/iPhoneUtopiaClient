...
var Apsalar={
    ...
    */
    ...
    /* Methods */
    ,event:function(name, withArgs){Apsalar.int_call('event', name, withArgs);}
    ...
    */ 
     ...
     */
    ,trigger:function(name){Apsalar.int_call('trigger',name);}
    /* update: Update read-only properties */
    ,update:function(){Apsalar.int_call('update');}
    /* Internal use only */
    ,int_callbacks:{}
